...
use noon_agent::{SharedBuf, SnapshotLine, SpanStyle};
use noon_lua::{Anchor, Axis, Border, FloatConfig, Split, TitlePos, WinCommand, WinEvent};
use ratatui::Frame;
...
mod tests {
    use super::*;
    use noon_agent::SnapshotSpan;
    use noon_lua::{Dimension, FloatConfigPatch};
