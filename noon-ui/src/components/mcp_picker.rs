...
use noon_agent::{McpConfigErrors, McpServerInfo, McpServerStatus, McpSnapshotReader};
        ...
        .map(|info| McpEntry {
            ...
            detail_text: match &info.status {
                ...
                McpServerStatus::NeedsAuth { .. } => {
                    format!(
                        "{} \u{00b7} needs auth \u{00b7} run 'noon mcp auth {}'",
...
mod tests {
    ...
    use noon_agent::{McpServerInfo, McpSnapshot};
        ...
        McpSnapshotReader::from_snapshot(McpSnapshot {
            infos: vec![
                McpServerInfo {
                    ...
                    config_path: PathBuf::from("/home/.config/noon/config.toml"),
                    url: None,
                },
                McpServerInfo {
                    name: "github".into(),
                    ...
                    config_path: PathBuf::from("/project/.noon/config.toml"),
                    url: None,
                },
            ],
            prompts: vec![],
