...
use noon_config::providers::{self, Protocol, ProviderDef, ProvidersConfig, slugify};
use noon_providers::catalog_providers_if_available;
...
pub struct LoginPicker {
    ...
    storage: Option<noon_storage::StateDir>,
}
...
impl LoginPicker {
    ...
    pub fn open(&mut self, storage: noon_storage::StateDir) {
