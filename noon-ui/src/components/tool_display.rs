...
use noon_providers::{ModelPricing, TokenUsage};
...
impl ToolLineBuilder {
    ...
    fn push_markdown_body(&mut self, text: &str) {
        ...
        let md_lines = text_to_lines(
            ...
            Some(noon_markdown::render::TOOL_OUTPUT_MAX_LINE_BYTES),
        );
...
mod tests {
    ...
    use noon_agent::tools::{BASH_TOOL_NAME, READ_TOOL_NAME, TASK_TOOL_NAME};
    use noon_agent::{SnapshotLine, SnapshotSpan, TextOutput, ToolInput, ToolOutput};
