...
use noon_agent::AgentInput;
use noon_agent::{BufferSnapshot, ToolInput, ToolOutput};
use noon_providers::{Message, ModelTier};
...
#[cfg(test)]
use noon_providers::ModelPricing;
...
#[cfg(test)]
pub(crate) fn test_model() -> noon_providers::Model {
    noon_providers::Model {
        id: "test-model".into(),
        provider: noon_providers::provider::ProviderKind::Anthropic,
        dynamic_slug: None,
        tier: noon_providers::ModelTier::Medium,
        family: noon_providers::ModelFamily::Claude,
...
mod tests {
    use super::*;
    use noon_agent::{SnapshotLine, SnapshotSpan, SpanStyle};
