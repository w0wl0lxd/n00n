...
const PROJECT_COMMAND_DIRS: &[&str] = &[".noon/commands", ".claude/commands"];
...
fn discover_commands_inner(
    ...
    for dir in noon_storage::paths::user_config_dirs(home, xdg_config, "commands") {
...
mod tests {
    ...
    fn discover_project_overrides_global() {
        ...
        let cmd_dir = project.path().join(".noon/commands");
        ...
        let global_cmd_dir = global.path().join(".noon/commands");
