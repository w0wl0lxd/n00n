...
use noon_providers::provider::{self, Provider};
...
impl SessionStore {
    fn open(session_id: NoonId, cwd: &str, model_spec: &str) -> Option<Self> {
    ...
    fn open_in(dir: StateDir, session_id: NoonId, cwd: &str, model_spec: &str) -> Self {
...
#[cfg(test)]
mod tests {
    use noon_storage::sessions::generate_title;
