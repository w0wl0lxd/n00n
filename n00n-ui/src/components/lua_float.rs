...
fn snapshot_to_line(sline: &SnapshotLine, theme_engine: &ThemeEngine) -> Line<'static> {
    Line::from(
        sline
            .spans
            .iter()
...
mod tests {
    ...
    fn open_close_lifecycle() {
        let mut mgr = FloatManager::new(crate::theme::test_engine());
    ...
    fn handle_paste_returns_false_when_empty() {
        let mgr = FloatManager::new(crate::theme::test_engine());
