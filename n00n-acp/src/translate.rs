...
use n00n_agent::types::{ToolDoneEvent, ToolOutput, ToolStartEvent};
use n00n_providers::{ContentBlock as MsgBlock, ImageMediaType, Message, Role as MsgRole};
...
mod tests {
    ...
    #[test_case(Some(n00n_providers::StopReason::ToolUse); "tool_use")]
    fn stop_reason_without_acp_equivalent_maps_to_end_turn(sr: Option<n00n_providers::StopReason>) {
        assert_eq!(
            map_stop_reason(sr),
            agent_client_protocol_schema::StopReason::EndTurn
        );
