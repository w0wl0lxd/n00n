"""Generate crates/n00n-providers/src/providers/cursor/models_data.rs from cursor-agent --list-models.
...
OUT = REPO_ROOT / "crates" / "n00n-providers" / "src" / "providers" / "cursor" / "models_data.rs"
