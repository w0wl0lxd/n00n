...
use noon_lua::{PluginHost, PluginPermissions};
...
fn os_getenv_reads_existing_var() {
    ...
    host.load_source(
        "getenv_existing",
        r#"
        local home = noon.uv.os_getenv("HOME")
...
fn os_getenv_returns_nil_for_missing_var() {
    ...
    host.load_source(
        "getenv_missing",
        r#"
        local val = noon.uv.os_getenv("NOON_TEST_VAR_DOES_NOT_EXIST_12345")
