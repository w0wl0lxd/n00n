...
n00n.api.register_prompt_hint({
  slot = "tool_usage",
  content = [[- When using the **read_file** tool, only read the sections you actually need.
- Use `wc -l` to check total number of lines before reading to decide a reasonable **read_file** tool limit unless known already.
