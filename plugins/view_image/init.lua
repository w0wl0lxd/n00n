...
n00n.api.register_tool({
  ...
  schema = {
    ...
    required = { "path", "tile_index", "tile_width", "tile_height", "crop", "static_image", "allow_gif_animation" },
    properties = {
      path = {
        type = "string",
        required = true,
        alias = "file_path",
        description = "Image file path (absolute, relative, or ~/)",
      },
      tile_index = {
        type = { "integer", "null" },
        minimum = 1,
        required = true,
        description = "One-based tile index for tiling large images",
      },
      tile_width = {
        type = { "integer", "null" },
        minimum = 1,
        ...
        required = true,
        description = "Tile width in pixels (default 2000; max 8000)",
      },
      tile_height = {
        type = { "integer", "null" },
        minimum = 1,
        maximum = MAX_PROVIDER_EDGE,
        required = true,
        description = "Tile height in pixels (default 2000; max 8000)",
      },
      crop = {
        type = { "array", "null" },
        items = { type = "integer" },
      ...
      static_image = {
        type = { "boolean", "null" },
        required = true,
        description = "Force static PNG (for animated GIF/webp)",
      },
      allow_gif_animation = {
        type = { "boolean", "null" },
        required = true,
        description = "Allow GIF animation (provider must support it)",
      },
    },
  },
