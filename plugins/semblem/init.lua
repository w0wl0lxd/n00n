...
n00n.api.register_prompt_hint({
  slot = "tool_usage",
  content = "- Use **search_text** for ranked keyword search across indexed source; use **map_code** or **map_codegraph** for structural graph maps, and **explore_code** for code questions.",
})
