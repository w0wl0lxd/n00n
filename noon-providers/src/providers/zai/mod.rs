...
use flume::Sender;
use noon_config::providers::{BuiltInProvider, Protocol, ProviderPlan};
...
impl Zai {
    pub fn new(timeouts: super::Timeouts) -> Result<Self, AgentError> {
        ...
        let provider_config = noon_config::providers::ProvidersConfig::load();
        if let Some(url) =
            noon_config::providers::resolve_base_url("zai", provider_config.get("zai"))
        {
