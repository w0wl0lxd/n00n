...
use noon_config::providers::builtin_provider;
...
use noon_storage::auth::load_provider_credentials;
...
fn enable_free_models_config() -> bool {
    noon_config::providers::ProvidersConfig::load()
        .get("opencode")
    ...
    async fn lookup(
        ...
        smol::unblock(move || {
            ...
            let auth = provider_data
                ...
                .ok_or_else(|| {
                    config_error(format!(
                        "authentication required for provider '{sub_provider}', run `noon auth login {sub_provider}`"
                    ))
                })?;
...
fn catalog_cache_path() -> Option<PathBuf> {
    let dir = noon_storage::paths::cache_dir().ok()?;
...
mod tests {
    ...
    fn catalog_provider_resolve_api_key_from_env() {
        ...
        let provider = CatalogProvider {
            name: "Test".into(),
            env: vec!["NOON_TEST_UNUSED_VAR_1"]
                .into_iter()
                .map(|s| s.to_string())
                .collect(),
            npm: "@ai-sdk/openai".into(),
    ...
    fn catalog_provider_build_auth_key_based() {
        let (_tmp, state_dir) = temp_state_dir();
        unsafe { std::env::set_var("NOON_TEST_AUTH_KEY", "sk-real-key") };
        let provider = CatalogProvider {
            name: "Test".into(),
            env: vec!["NOON_TEST_AUTH_KEY"]
                .into_iter()
                .map(|s| s.to_string())
                .collect(),
            npm: "@ai-sdk/openai-compatible".into(),
        ...
        unsafe { std::env::remove_var("NOON_TEST_AUTH_KEY") };
    }

    #[test]
    fn catalog_provider_build_auth_x_api_key() {
        let (_tmp, state_dir) = temp_state_dir();
        unsafe { std::env::set_var("NOON_TEST_ANTHROPIC_KEY", "sk-ant-key") };
        let provider = CatalogProvider {
            name: "Anthropic".into(),
            env: vec!["NOON_TEST_ANTHROPIC_KEY"]
                .into_iter()
                .map(|s| s.to_string())
                .collect(),
            npm: "@ai-sdk/anthropic".into(),
        ...
        unsafe { std::env::remove_var("NOON_TEST_ANTHROPIC_KEY") };
    }
    ...
    fn catalog_to_data_filters_nonfree_without_key() {
        ...
        providers.insert(
            ...
            CatalogProvider {
                name: "Vendor".into(),
                env: vec!["NOON_TEST_VENDOR_KEY_60924".into()],
                npm: "@ai-sdk/openai-compatible".into(),
    ...
    fn catalog_to_data_opencode_all_models_with_key() {
        ...
        providers.insert(
            ...
            CatalogProvider {
                name: "Opencode".into(),
                env: vec!["NOON_TEST_OPENCODE_ALL_81274".into()],
                npm: "@ai-sdk/openai-compatible".into(),
                api: Some("https://opencode.ai/zen/v1".into()),
                models,
            },
        ...
        unsafe { std::env::set_var("NOON_TEST_OPENCODE_ALL_81274", "real-key") };
        let result = CatalogData::from_index(providers, true, &state_dir);
        ...
        unsafe { std::env::remove_var("NOON_TEST_OPENCODE_ALL_81274") };
    }
    ...
    fn catalog_to_data_all_models_with_key() {
        ...
        providers.insert(
            ...
            CatalogProvider {
                name: "Vendor".into(),
                env: vec!["NOON_TEST_VENDOR_KEY_81274".into()],
                npm: "@ai-sdk/openai-compatible".into(),
                api: Some("https://vendor.api/v1".into()),
                models,
            },
        ...
        unsafe { std::env::set_var("NOON_TEST_VENDOR_KEY_81274", "test-key") };
        let result = CatalogData::from_index(providers, true, &state_dir);
        unsafe { std::env::remove_var("NOON_TEST_VENDOR_KEY_81274") };
    ...
    fn catalog_to_data_handles_model_id_collisions() {
        ...
        providers.insert(
            ...
            CatalogProvider {
                name: "Other".into(),
                env: vec!["NOON_TEST_OTHER_KEY_COLLISION".into()],
                npm: "@ai-sdk/openai-compatible".into(),
        ...
        unsafe { std::env::set_var("NOON_TEST_OTHER_KEY_COLLISION", "key") };
        let result = CatalogData::from_index(providers, true, &state_dir);
        unsafe { std::env::remove_var("NOON_TEST_OTHER_KEY_COLLISION") };
    ...
    fn lookup_finds_model_id_with_slashes() {
        ...
        providers.insert(
            ...
            CatalogProvider {
                name: "NVIDIA".into(),
                env: vec!["NOON_TEST_NVIDIA_KEY_LOOKUP".into()],
                npm: "@ai-sdk/openai-compatible".into(),
        ...
        unsafe { std::env::set_var("NOON_TEST_NVIDIA_KEY_LOOKUP", "key") };
        let data = CatalogData::from_index(providers, true, &state_dir);
        unsafe { std::env::remove_var("NOON_TEST_NVIDIA_KEY_LOOKUP") };
    ...
    fn lookup_spec_is_sub_provider_plus_model_id() {
        ...
        providers.insert(
            ...
            CatalogProvider {
                name: "NVIDIA".into(),
                env: vec!["NOON_TEST_NVIDIA_DIRECT".into()],
                npm: "@ai-sdk/openai-compatible".into(),
                api: Some("https://nvapi.xyz/v1".into()),
                models,
            },
        ...
        unsafe { std::env::set_var("NOON_TEST_NVIDIA_DIRECT", "key") };
        let data = CatalogData::from_index(providers, true, &state_dir);
        unsafe { std::env::remove_var("NOON_TEST_NVIDIA_DIRECT") };
    ...
    fn lookup_nested_model_id_uses_sub_provider_key() {
        ...
        providers.insert(
            ...
            CatalogProvider {
                name: "Fireworks".into(),
                env: vec!["NOON_TEST_FIREWORKS_DEEP".into()],
                npm: "@ai-sdk/openai-compatible".into(),
        ...
        unsafe { std::env::set_var("NOON_TEST_FIREWORKS_DEEP", "key") };
        let data = CatalogData::from_index(providers, true, &state_dir);
        unsafe { std::env::remove_var("NOON_TEST_FIREWORKS_DEEP") };
