...
use noon_config::providers::Protocol;
...
fn resolve_protocol_for_local(slug: &str) -> Option<Protocol> {
    noon_config::providers::resolve_protocol(
        slug,
        noon_config::providers::ProvidersConfig::load().get(slug),
    )
}
...
impl LocalEndpoint {
    pub fn new(
        ...
        let host = noon_config::providers::ProvidersConfig::load()
            .get(cfg.slug)
