...
use noon_storage::sessions::{MIN_THINKING_BUDGET, StoredTokenUsage};
...
impl From<noon_config::providers::Tier> for ModelTier {
    fn from(t: noon_config::providers::Tier) -> Self {
        use noon_config::providers::Tier;
        match t {
            Tier::Weak => Self::Weak,
