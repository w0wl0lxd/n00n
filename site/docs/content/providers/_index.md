...
- **Features**: ChatGPT/Codex plan via OAuth device flow; Daybreak and Cyber models require approved access
...
| Strong | **gpt-5.6-sol** (default), gpt-daybreak-blue-latest, gpt-daybreak-red-latest, gpt-5.6-cyber, gpt-5.4, o3, gpt-5.3-codex-spark, gpt-5.3-codex, gpt-5.2-codex, gpt-5.1-codex-max, gpt-5.1-codex | $5.00 / $30.00 | 272K ctx / 128K out |
...
Defaults: composer-2.5 (strong), gpt-5.1 (medium), gemini-3-flash (weak)
