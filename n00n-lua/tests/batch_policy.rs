...
n00n.agent.call_tool = function(ctx, name, input, opts)
...
n00n.api.register_tool({
  ...
  handler = function(input, ctx)
    return (n00n.json.encode(recorder))
  end,
})
...
n00n.api.register_tool({
  name = "cmd",
  description = "restore awaits n00n.ui.highlight inline",
  schema = { type = "object", properties = {} },
  audiences = { "main" },
  restore = function(input, output, is_error, rctx)
    local buf = n00n.ui.buf()
    local view = ToolView.new(buf, { max_lines = 10, keep = "tail" })
    local header = n00n.ui.highlight("echo header-marker", "bash") or { { { "echo header-marker" } } }
