...
pub use types::{
    ...
    QuestionAnswer, QuestionInfo, QuestionOption, RawRenderHints, SharedBuf, SnapshotLine,
    SnapshotSpan, SpanStyle, SubagentInfo, TodoItem, TodoPriority, TodoStatus, ToolDoneEvent,
