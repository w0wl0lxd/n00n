Return a compact skeleton of a source file: imports, type definitions, function signatures, and structure with line numbers. ~70-90% fewer tokens than reading the full file.
