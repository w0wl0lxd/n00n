...
const ACTIONS: &[(KeybindContext, &[(&str, KeyAction)])] = &[
    ...
    (
        ...
        &[
            ...
            ("undo", KeyAction::Undo),
            ("redo", KeyAction::Redo),
            ("select_char_left", KeyAction::SelectCharLeft),
            ("select_char_right", KeyAction::SelectCharRight),
            ("select_word_left", KeyAction::SelectWordLeft),
            ("select_word_right", KeyAction::SelectWordRight),
            ("select_line_start", KeyAction::SelectLineStart),
            ("select_line_end", KeyAction::SelectLineEnd),
            ("select_up", KeyAction::SelectUp),
            ("select_down", KeyAction::SelectDown),
